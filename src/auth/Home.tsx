                        ...
                        <div className="bg-gray-900">
                            <div className="mx-auto flex h-16 max-w-7xl items-center justify-end px-4 sm:px-6 lg:px-8">
                                ...
                                {/* <form>
                                    <div>
                                        ...
                                        <div className="group relative -ml-2 rounded-md border-transparent bg-gray-900 focus-within:ring-2 focus-within:ring-white">
                                            ...
                                            <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center">
                                                <CircleUser aria-hidden="true" className="h-5 w-5 text-gray-300" />
                                            </div>
                                        </div>
                                    </div>
                                </form> */}
                                ...
                                <div className="flex items-center space-x-6">
                                    <Link to="/login" className="text-lg font-medium text-white hover:text-blue-500">
                                        Login
                                    </Link>
                                    <Link to="/register" className="text-lg font-medium text-white hover:text-blue-500">
                                        Registrarse
                                    </Link>
                                </div>
                            </div>
                                            ...
                                            <div className="flex items-center lg:ml-8">
                                                ...
                                                <div className="ml-4 flow-root lg:ml-8">
                                                    <a href="#" className="group -m-2 flex items-center p-2">
                                                        <CircleUser aria-hidden="true" className="h-6 w-6 flex-shrink-0 text-white" />
